...
public class CallSession
{
	...
	public static VPayload PAYLOAD_H263 = new VPayload(34, "H263", 90000, 512000, 640, 400, 30);
	public static VPayload PAYLOAD_H264 = new VPayload(97, "H264", 90000, 512000, 640, 400, 30);
	public static VPayload PAYLOAD_H264SVC = new VPayload(96, "H264-SVC", 90000, 512000, 640, 400, 30);
	...
	private void parseJingleSession(StreamElement session, boolean offer)
	{
		...
		{
			StreamElement desc = (StreamElement)content;
			boolean video = false;
			if(desc.getAttributeValue("media").equals("video"))
			{
				video = true;
